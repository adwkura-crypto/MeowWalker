  ...
  return (
    <div className="relative group" ref={wrapperRef}>
      ...
      {showDropdown && (query.length > 1) && (
        <div className="absolute z-[1000] w-full bg-white mt-1.5 rounded-xl shadow-xl border border-gray-100 max-h-64 overflow-y-auto animate-fade-in overflow-hidden">
           {loading ? (
